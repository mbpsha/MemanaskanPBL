...
<template>
    <AdminLayout>
        ...
        <div
            ...
            class="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-2 sm:p-4"
        >
            <div
                @click.stop
                class="relative bg-white rounded-xl sm:rounded-2xl max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden w-full"
            >
                <div
                    class="sticky top-0 bg-white border-b px-3 sm:px-6 py-3 sm:py-4 flex justify-between items-center"
                >
                    <h3
                    ...
                    <button
                        @click="closeImageModal"
                        class="text-gray-500 hover:text-gray-700 text-xl sm:text-2xl font-bold w-8 h-8 flex items-center justify-center"
                    >
                        ×
                    </button>
                </div>
                <div
                    class="p-3 sm:p-6 overflow-auto max-h-[calc(95vh-60px)] sm:max-h-[calc(90vh-80px)]"
                >
                    <img
                        :src="selectedImage"
